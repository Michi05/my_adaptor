"""autogenerated by genpy from my_adaptor/setStringRequest.msg. Do not edit."""
import sys
...
class setStringRequest(genpy.Message):
  ...
  _type = "my_adaptor/setStringRequest"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.newValue = str[start:end].decode('utf-8')
      else:
...
"""autogenerated by genpy from my_adaptor/setStringResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class setStringResponse(genpy.Message):
  ...
  _type = "my_adaptor/setStringResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.setAnswer = str[start:end].decode('utf-8')
      else:
