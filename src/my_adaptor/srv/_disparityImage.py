"""autogenerated by genpy from my_adaptor/disparityImageRequest.msg. Do not edit."""
import sys
...
class disparityImageRequest(genpy.Message):
  _md5sum = "af8ad02b46d61aef136a826c5d08279b"
  _type = "my_adaptor/disparityImageRequest"
...
"""autogenerated by genpy from my_adaptor/disparityImageResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class disparityImageResponse(genpy.Message):
  _md5sum = "d5350e6c86b184588c462e9541f40dbb"
  _type = "my_adaptor/disparityImageResponse"
  _has_header = False #flag to mark the presence of a Header object
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v21.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v21.data = str[start:end].decode('utf-8')
        else:
...
class disparityImage(object):
  _type          = 'my_adaptor/disparityImage'
