...
(cl:defmethod cl:initialize-instance :after ((m <floatValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'floatValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<floatValue-request> is deprecated: use my_adaptor-srv:floatValue-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <floatValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'floatValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<floatValue-response> is deprecated: use my_adaptor-srv:floatValue-response instead.")))
