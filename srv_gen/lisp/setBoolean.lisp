...
(cl:defmethod cl:initialize-instance :after ((m <setBoolean-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setBoolean-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setBoolean-request> is deprecated: use my_adaptor-srv:setBoolean-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <setBoolean-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setBoolean-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setBoolean-response> is deprecated: use my_adaptor-srv:setBoolean-response instead.")))
