...
(cl:defmethod cl:initialize-instance :after ((m <requestTopic-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requestTopic-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<requestTopic-request> is deprecated: use my_adaptor-srv:requestTopic-request instead.")))

(cl:ensure-generic-function 'nImages-val :lambda-list '(m))
(cl:defmethod nImages-val ((m <requestTopic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:nImages-val is deprecated.  Use my_adaptor-srv:nImages instead.")
  (nImages m))

(cl:ensure-generic-function 'sourceTopic-val :lambda-list '(m))
(cl:defmethod sourceTopic-val ((m <requestTopic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:sourceTopic-val is deprecated.  Use my_adaptor-srv:sourceTopic instead.")
  (sourceTopic m))

(cl:ensure-generic-function 'responseTopic-val :lambda-list '(m))
(cl:defmethod responseTopic-val ((m <requestTopic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:responseTopic-val is deprecated.  Use my_adaptor-srv:responseTopic instead.")
  (responseTopic m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requestTopic-request>)))
  ...
  "my_adaptor/requestTopicRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requestTopic-request)))
  "Returns string type for a service object of type 'requestTopic-request"
  "my_adaptor/requestTopicRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <requestTopic-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requestTopic-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<requestTopic-response> is deprecated: use my_adaptor-srv:requestTopic-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <requestTopic-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:response-val is deprecated.  Use my_adaptor-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requestTopic-response>)))
  ...
  "my_adaptor/requestTopicResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requestTopic-response)))
  "Returns string type for a service object of type 'requestTopic-response"
  "my_adaptor/requestTopicResponse")
