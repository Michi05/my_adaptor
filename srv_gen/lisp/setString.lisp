...
(cl:defmethod cl:initialize-instance :after ((m <setString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setString-request> is deprecated: use my_adaptor-srv:setString-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <setString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setString-response> is deprecated: use my_adaptor-srv:setString-response instead.")))
