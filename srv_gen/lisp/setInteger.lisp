...
(cl:defmethod cl:initialize-instance :after ((m <setInteger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setInteger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setInteger-request> is deprecated: use my_adaptor-srv:setInteger-request instead.")))
...
(cl:defmethod newValue-val ((m <setInteger-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:newValue-val is deprecated.  Use my_adaptor-srv:newValue instead.")
  (newValue m))
...
(cl:defmethod cl:initialize-instance :after ((m <setInteger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setInteger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setInteger-response> is deprecated: use my_adaptor-srv:setInteger-response instead.")))

(cl:ensure-generic-function 'setAnswer-val :lambda-list '(m))
(cl:defmethod setAnswer-val ((m <setInteger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_adaptor-srv:setAnswer-val is deprecated.  Use my_adaptor-srv:setAnswer instead.")
  (setAnswer m))
