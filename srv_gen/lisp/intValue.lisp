...
(cl:defmethod cl:initialize-instance :after ((m <intValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'intValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<intValue-request> is deprecated: use my_adaptor-srv:intValue-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <intValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'intValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<intValue-response> is deprecated: use my_adaptor-srv:intValue-response instead.")))
