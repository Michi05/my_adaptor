...
(cl:defmethod cl:initialize-instance :after ((m <setFloat-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setFloat-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setFloat-request> is deprecated: use my_adaptor-srv:setFloat-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <setFloat-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'setFloat-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_adaptor-srv:<setFloat-response> is deprecated: use my_adaptor-srv:setFloat-response instead.")))
